...
<body>
	...
	<table border="1">
		...
		<c:forEach var="chucVu" items="${listChucVus}">
			<tr bgcolor="green">
				<th style="font-size: 50px">${chucVu.id}</th>
				<th style="font-size: 50px">${chucVu.maChucVu}</th>
				<th style="font-size: 50px">${chucVu.tenChucVu}</th>
				<th style="font-size: 50px">${chucVu.moTa}</th>
